...
#include "../../Header/GraphicEngine/Sprite.hpp"

/* explicit */ Sprite::Sprite() :
        m_texture(nullptr),
        m_textureRect()
{
    // None
...
/* explicit */ Sprite::Sprite(const sf::Texture& texture) :
        m_texture(nullptr),
        m_textureRect()
{
    setTexture(texture);
...
/* explicit */ Sprite::Sprite(const sf::Texture& texture, const sf::IntRect& rectangle) :
        m_texture(nullptr),
        m_textureRect()
{
    setTexture(texture);
...
/* virtual */ void Sprite::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
    if (m_texture)
    {
